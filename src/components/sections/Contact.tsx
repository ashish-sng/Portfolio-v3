        ...
        <div className="space-y-spacing-sm">
          ...
          <Text variant="body">
            <a
              ...
              className="text-foreground transition-colors duration-200 hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
            >
